...
func setupMsgServerWithOneGameFromPlayMove(t testing.TB) (types.MsgServer, keeper.Keeper, context.Context) {
...
func TestPlayMove(t *testing.T) {
	msgServer, _, context := setupMsgServerWithOneGameFromPlayMove(t)
...
func TestPlayMoveCannotParseGame(t *testing.T) {
    msgServer, k, context := setupMsgServerWithOneGameFromPlayMove(t)
